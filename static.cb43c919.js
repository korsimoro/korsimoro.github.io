        ...
        _react2.default.createElement(
            ...
            _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    'explorers and exportable',
                    _react2.default.createElement(
                        _TextLink2.default,
                        { to: 'https://gephi.org/' },
                        'Gephi'
                    ),
                    ' graphs powered by traditional API-backed NoSQL databases.  Using these tools we track the state of the art in digital identity.'
                ),
                _react2.default.createElement(
                    _basicElements.List,
...
var TopText = function TopText(props) {
  return _react2.default.createElement(
    ...
    '.  We have introduced a physical testbed of non-electronic identities and are in the process of deploying a card based PoC.  This silly project, precisely because it involves absolutely no sensitive data, is a fundamental test of the technical reality of bootstrapping and managing a limited identity domain.'
  );
};
...
var TopText = function TopText(props) {
  return _react2.default.createElement(
    ...
    'Furthermore, larger database of reference cases is required for comparative evaluation of legal frameworks such as the ',
    _react2.default.createElement(
      _TextLink2.default,
      { to: 'https://www.evernym.com/wp-content/uploads/2017/07/SovrinProvisionalTrustFramework2017-03-22.pdf' },
      'Sovrin Trust Framework'
    ),
    ', domain specific trust frameworks, and the explicit and implicit trust frameworks of blockchain solutions, many of which ultimately rely upon the KYC procedures of cryptocurrency exchanges.'
  );
};
...
//# sourceMappingURL=static.cb43c919.js.map